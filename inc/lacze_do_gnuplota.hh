...
class LaczeDoGNUPlota {
 ...
 public:
  ...
  void WyswietlajKomunikatyBledow( bool Tryb = true );
    ...
    *            dla \e gnuplota.LaczeDoGNUPlota
  ...
  /*  USUN NAZWE PLIKU
      ...
      Metoda pozwala na usuniecie podanej nazwy pliku
      Jako parametr podaje sie:
        i - ta nazwe pliku z wczytanych wczesniej plikow        */
  void UsunNazwePliku(unsigned int i);
  ...
  /*  WEZ NAZWE PLIKU
      ...
      LaczeDoGnuplota*/
  const std::string WezNazwePliku(unsigned int i) const;

  /*  WEZ LICZBE PLIKOW

      Metoda zwraca liczbe wczytanych plikow            */
  unsigned int WezLiczbePlikow() {return _InfoPlikow.size(); }
  ...
  void WczytajDoGnuPlota(const ListaPrzeszkod &Lista);
